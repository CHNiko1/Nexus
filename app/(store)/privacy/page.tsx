  ...
  return (
    <div className="container py-12">
      <div className="mx-auto max-w-3xl prose prose-slate dark:prose-invert">
        ...
        <h2>Introduction</h2>
        <p>
          Vine Dropshipping ("we", "our", or "us") is committed to protecting your privacy. This
        ...
        <ul>
          <li><strong>Service Providers:</strong> Third parties who help us operate our business
            (e.g., payment processors, shipping carriers)</li>
